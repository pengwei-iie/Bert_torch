...
from examples.run_squad_dataset_utils import read_squad_examples, convert_examples_to_features, RawResult, write_predictions
...
def main():
    ...
    if args.do_train:
        ...
        train_data = TensorDataset(all_input_ids, all_input_mask, all_segment_ids, all_doc_len,
